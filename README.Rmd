...
The solution is to download the file first then read from there. The "mode" option is needed to download the file correctly (xlsx files are zip files, so they must be downloaded as binary). 
